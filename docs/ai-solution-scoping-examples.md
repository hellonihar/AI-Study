...
| 27 | Factory energy consumption 20% above benchmark | See **[FactoryRL](../projects/industry-solutions/manufacturing-industrial/factoryrl/design.md)** — MPC + LightGBM optimizer: learns dynamics model, solves constrained optimization every 15 min for HVAC + production schedule | BMS integration, production scheduler API, savings verification methodology, energy intensity reduction target |
